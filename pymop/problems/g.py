...
class G3(Problem):
    ...
    def _calc_pareto_set(self):
        return anp.array([0.31624357647283069,
...
class G4(Problem):
    ...
    def _calc_pareto_set(self):
        return anp.array([78, 33, 29.9952560256815985, 45, 36.7758129057882073])
...
class G5(Problem):
    ...
    def _calc_pareto_set(self):
        return anp.array([679.945148297028709, 1026.06697600004691, 0.118876369094410433, -0.39623348521517826])
...
class G7(Problem):
    ...
    def _calc_pareto_set(self):
        return anp.array([2.17199634142692, 2.3636830416034,
...
class G8(Problem):
    ...
    def _calc_pareto_set(self):
        return anp.array([1.22797135260752599, 4.24537336612274885])
...
class G9(Problem):
    ...
    def _calc_pareto_set(self):
        return anp.array([2.33049935147405174, 1.95137236847114592, -0.477541399510615805,
